...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'news.context_processors.kategorie',                        #custom processors for showing category in base html file
                'news.context_processors.breaking',                         #custom processors for showing breaking news in base html file
            ],
        },
    },
]
